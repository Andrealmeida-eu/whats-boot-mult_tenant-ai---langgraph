...
class ItemPedido(Base, TenantMixin):
    ...
    preco_unitario = Column(Float, nullable=False) # Salva o preço no momento da compra (caso o cardápio mude)
...
class Pedido(Base, TenantMixin):
    ...
    tipo_entrega = Column(String(50), default="DELIVERY")  # DELIVERY ou BALCAO
    endereco_entrega = Column(String(255), nullable=True)  # Onde este pedido ESPECÍFICO vai
