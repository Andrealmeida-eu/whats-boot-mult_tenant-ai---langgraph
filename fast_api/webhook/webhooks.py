...
from core.data.redis.message_buffer import buffer_message
from core.data.redis.message_dedupe import dedupe_check_and_mark
from core.utils.message import extract_message_evolution, is_group, extract_message_meta
from core.config.tenants import tenant_service
from core.data.database.conection.conection_orm import get_db

from core.data.database.model.base_tenant.tenantBase import Tenant as TenantModel
...
async def webhook_evolution(
    ...
    await buffer_message(tenant_id=conf.id, chat_id=chat_id, message=text, name_cliente=nome_cliente)
